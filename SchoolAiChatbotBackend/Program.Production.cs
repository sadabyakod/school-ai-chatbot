    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                // Register Exam Submission services
                ...
                // Register Exam Storage service (Database-backed)
                builder.Services.AddSingleton<IExamStorageService, DatabaseExamStorageService>();

                // Register Subjective Rubric services
                ...
                app.Use(async (context, next) =>
                {
                    ...
                    logger.LogInformation("Request: {Method} {Path} from {RemoteIp} Origin={Origin}",
                        context.Request.Method, context.Request.Path, ip, origin);
                ...
                // Use CORS with AllowAnyOrigin for production (no credentials needed for public API)
                ...
                app.MapGet("/", () => Results.Ok(new { message = "School AI Chatbot Backend is running with Azure SQL Server", version = "1.0.3", timestamp = DateTime.UtcNow }));
